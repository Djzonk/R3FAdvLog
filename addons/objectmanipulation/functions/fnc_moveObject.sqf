...
if (isNull (_object getVariable [QGVAR(movedBy), objNull]) || (!alive (_object getVariable [QGVAR(movedBy), objNull])) || (!isPlayer (_object getVariable [QGVAR(movedBy), objNull]))) then {
    ...
    if (isNull (_object getVariable ["R3F_LOG_remorque", objNull])) then {
        ...
        if (_object getVariable QGVAR(movedBy) == _player) then {
